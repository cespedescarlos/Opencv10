...
public class Momentos_Hu {
    ...
    public Momentos_Hu(int posicion_momento, double m0, double m1, double m2, double m3, double m4, double m5, double m6, double promedio) {
    ...
    public boolean comparacion(Momentos_Hu momento1, Momentos_Hu momento2){
    ...
    public static List<Momentos_Hu> limpiar_lista(List<Momentos_Hu> list){
        if(list!=null &&list.size()>0){
            List<Momentos_Hu> nueva=new ArrayList<>();
            for (int i = 0; i < list.size(); i++) {
                Momentos_Hu get = list.get(i);
